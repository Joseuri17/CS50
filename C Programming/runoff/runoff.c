...
int main(int argc, string argv[])
{
    ...
    for (int i = 0; i < voter_count; i++)
    {
        ...
        {
            printf("Voter %i ", i);
            // J is my rank system of voter i
...
{
    // TODO
    // looping through the voters
    for (int i = 0; i < voter_count; i++)
    {
        // looping through the candidate names
        for (int j = 0; j < candidate_count; j++)
        {
            //comparing name to all candidates
            if (strcmp(candidates[j].name, name) == 0)
            {
                //if it matches we will link prefrences[i][j] to the candidate index of j
